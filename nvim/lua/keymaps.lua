...
keymap("n", ";x", "<cmd>Lspsaga code_action<cr>", { silent = true, noremap = true })
keymap("x", ";x", ":<c-u>Lspsaga range_code_action<cr>", { silent = true, noremap = true })
keymap("n", "K", "<cmd>Lspsaga hover_doc<cr>", { silent = true, noremap = true })
keymap("n", ";o", "<cmd>Lspsaga show_line_diagnostics<cr>", { silent = true, noremap = true })
keymap("n", ";j", "<cmd>Lspsaga diagnostic_jump_next<cr>", { silent = true, noremap = true })
keymap("n", ";k", "<cmd>Lspsaga diagnostic_jump_prev<cr>", { silent = true, noremap = true })
